  ...
  export default{
    ...
    methods: {
      ...
      sub(arr_dic, to){
        ...
        .then(r => {
          console.log('save: ', r.data.file_down)
          console.log('real: ', r.data.file_up)
          arr_dic.push({obj: arr_dic[0].obj, key: 'file_up', value: r.data.file_up}, {obj: arr_dic[0].obj, key: 'file_down', value: r.data.file_down})
        })
